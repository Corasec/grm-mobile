...
import { i18n } from '@/src/shared/translations/i18n';
import { useDispatch } from 'react-redux';
import styles from './Content.style';
import ProfileItem from '@/src/features/profile/screens/Profile/components/ProfileItem';
import { logout } from '@/src/shared/store/ducks/authentication.duck';
import { Button } from 'react-native-paper';
import SmallCard from '@/src/features/profile/screens/Profile/components/SmallCard';
import { colors } from '@/src/shared/utils/colors';
import { baseURL } from '@/src/features/authentication/services/authService';
  ...
  return (
    <View>
      ...
      <View style={styles.cardContainer}>
        <SmallCard
        style={{marginHorizontal: 40, width: 150}}
