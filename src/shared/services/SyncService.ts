...
import type {
  CreatedResponseWithBackendId,
  WatermelonId,
} from '@/src/shared/services/BaseService';
import { TABLE_NAMES } from '../migrations/tableName';
import { fetchIssueList } from '@/src/features/dashboard/services/issues/IssueService';
import { Syncable } from './types';
import { databaseServiceInstance } from '@/src/shared/utils/storageManager';
import { removeDuplicates } from '@/src/shared/utils/utils';
import { Issue } from '@/src/features/dashboard/models/issues/Issue';
